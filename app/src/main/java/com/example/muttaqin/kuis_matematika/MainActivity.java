package com.example.muttaqin.kuis_matematika;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        classShardPref = new SharedPrefen(MainActivity.this.getApplicationContext());
    ...
    public void cekJawaban(View view) {
        ...
        if (cekIfKosong.isEmpty()) {
            hasilJawab.setText("Mohon dijawab terlebih dahulu");
            hasilJawab.setBackgroundColor(0xFFFFFF00);
        } else {
